...
```
E:\cad-2025\les08\lab>.\gradlew run

> Task :app:run
13:34:10 INFO  org.springframework.data.repository.config.RepositoryConfigurationDelegate - Bootstrapping Spring Data JPA repositories in DEFAULT mode.
13:34:10 INFO  org.springframework.data.repository.config.RepositoryConfigurationDelegate - Finished Spring Data repository scanning in 40 ms. Found 5 JPA repository interfaces.
13:34:11 INFO  org.hibernate.orm.jpa - HHH008540: Processing PersistenceUnitInfo [name: default]
13:34:11 INFO  org.hibernate.orm.core - HHH000001: Hibernate ORM core version 7.3.1.Final
13:34:11 INFO  org.springframework.orm.jpa.persistenceunit.SpringPersistenceUnitInfo - No LoadTimeWeaver setup: ignoring JPA class transformer
13:34:11 INFO  com.zaxxer.hikari.HikariDataSource - HikariPool-1 - Starting...
13:34:11 INFO  com.zaxxer.hikari.pool.HikariPool - HikariPool-1 - Added connection conn0: url=jdbc:h2:./data/testdb user=SA
13:34:11 INFO  com.zaxxer.hikari.HikariDataSource - HikariPool-1 - Start completed.
13:34:11 WARN  org.hibernate.orm.deprecation - HHH90000025: H2Dialect does not need to be specified explicitly using 'hibernate.dialect' (remove the property setting and it will be selected by default)
13:34:11 INFO  org.hibernate.orm.connections.pooling - HHH10001005: Database info:
        Database JDBC URL [jdbc:h2:./data/testdb]
...
13:34:12 INFO  org.hibernate.orm.core - HHH000489: No JTA platform available (set 'hibernate.transaction.jta.platform' to enable JTA platform integration)
13:34:12 INFO  org.hibernate.orm.jdbc.batch - HHH100501: Automatic JDBC statement batching enabled (maximum batch size 10)
Hibernate:
...
13:34:12 INFO  org.springframework.orm.jpa.LocalContainerEntityManagerFactoryBean - Initialized JPA EntityManagerFactory for persistence unit 'default'
13:34:12 INFO  org.springframework.data.jpa.repository.query.QueryEnhancerFactories - Hibernate is in classpath; If applicable, HQL parser will be used.
Hibernate:
    insert
    into
        categories
...
Hibernate:
    ...
    from
        orders o1_0
13:34:13 INFO  ru.bsuedu.cad.lab.app.OrderClient - Orders before create: 0
Hibernate:
    select
        c1_0.customer_id,
        c1_0.address,
...
Hibernate:
    ...
    where
        product_id=?
13:34:13 INFO  ru.bsuedu.cad.lab.app.OrderClient - Created order id: 1
13:34:13 INFO  ru.bsuedu.cad.lab.app.OrderClient - Created order total: 3300.00
13:34:13 INFO  ru.bsuedu.cad.lab.app.OrderClient - Created order status: NEW
Hibernate:
    select
        count(*)
    from
        orders o1_0
13:34:13 INFO  ru.bsuedu.cad.lab.app.OrderClient - Orders after create: 1
Hibernate:
    select
        o1_0.order_id,
        o1_0.customer_id,
    ...
    where
        o1_0.order_id=?
13:34:13 INFO  ru.bsuedu.cad.lab.app.OrderClient - Loaded from DB: id=1, customer=Алексей Иванов, total=3300.00, status=NEW
13:34:13 INFO  org.springframework.orm.jpa.LocalContainerEntityManagerFactoryBean - Closing JPA EntityManagerFactory for persistence unit 'default'
Hibernate:
    drop table if exists categories cascade
Hibernate:
    drop table if exists customers cascade
...
Hibernate:
    drop table if exists products cascade
13:34:13 INFO  com.zaxxer.hikari.HikariDataSource - HikariPool-1 - Shutdown initiated...
13:34:13 INFO  com.zaxxer.hikari.HikariDataSource - HikariPool-1 - Shutdown completed.
